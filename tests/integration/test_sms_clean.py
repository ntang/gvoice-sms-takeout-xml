...
class TestSMSCoreInfrastructure(unittest.TestCase):
    ...
    def test_index_html_generation(self):
        """Test index.html generation functionality with new template format."""
        test_dir = Path(self.test_dir)
        sms.setup_processing_paths(test_dir, False, False, None)
        ...
        # Check index.html content matches new template format
        ...
        self.assertIn("2 conversations", content)  # Updated format
        self.assertIn("Processing completed in 1.5", content)  # New format
        self.assertIn("Generated by Google Voice SMS Takeout XML Converter", content)  # Footer
