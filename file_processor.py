    ...
    try:
        ...
        if file_type == "sms_mms":
            return process_sms_mms_file(
                html_file, soup, own_number, src_filename_map, conversation_manager, phone_lookup_manager
            )
        elif file_type == "call":
...
def process_call_file(
    ...
    if call_info:
        return {
            "num_sms": 0, "num_img": 0, "num_vcf": 0,
            "num_calls": 1, "num_voicemails": 0, "own_number": own_number
        }
    else:
        return {
            "num_sms": 0, "num_img": 0, "num_vcf": 0,
...
def process_voicemail_file(
    ...
    if voicemail_info:
        return {
            "num_sms": 0, "num_img": 0, "num_vcf": 0,
            "num_calls": 0, "num_voicemails": 1, "own_number": own_number
        }
    else:
        return {
            "num_sms": 0, "num_img": 0, "num_vcf": 0,
